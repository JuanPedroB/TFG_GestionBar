...
public class PnlEditarProducto extends JPanel {
	...
	public PnlEditarProducto() {
		...
		JLabel lblNewLabel_3 = new JLabel("Editar nombre y precio del producto:");
		lblNewLabel_3.setForeground(new Color(49, 163, 250));
		lblNewLabel_3.setFont(new Font("Lucida Sans Unicode", Font.BOLD, 14));
		
		JLabel lblNewLabel_3_1 = new JLabel("Editar la categor\u00EDa del producto:");
		...
		JLabel lblNewLabel_4 = new JLabel("Editar imagen del producto (opcional):");
		...
		JLabel lblAadirProducto = new JLabel("Editar producto");
